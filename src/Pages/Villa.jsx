    ...
    <div>
        ...
        <div className='container'>
              <div className="container--header">
                <h2>VILLAS</h2>
                <p>Grâce à notre maîtrise de la cartographie Abidjanaise et les connexions solides 
                    que nous avons tissés avec les partenaires du secteur depuis plusieurs années 
